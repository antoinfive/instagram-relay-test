...
export default function CreatePostMutation(description, imageUrl, viewerId, callback) {
  ...
  commitMutation(
    environment,
    {
      ...
      /* optimistically updates a proxyStore before waiting for the server to respond */
      ...
      /* this function updates the actual store and retrieves the response from the GraphQL server */
      updater: (proxyStore) => {
